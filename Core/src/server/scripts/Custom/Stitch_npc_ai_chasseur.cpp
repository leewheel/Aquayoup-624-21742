...
public: Stitch_npc_ai_chasseur() : CreatureScript("Stitch_npc_ai_chasseur") { }
		...
		struct Stitch_npc_ai_chasseurAI : public ScriptedAI
		{
			...
			uint32 BrancheSpe = 1;													// Choix de la Sp�cialisation : Survie = 1, Bete = 2 
			...
			uint32 Cooldown_Spell_Heal = 6000;											// Cooldown pour la fr�quence du heal
			...
			// Spells Divers
			uint32 Buf_all = 31519;														// Aura de pr�cision (60s) 31519
			...
			uint32 branche1_agro[5] = { 145663, 145663, 82941, 82941, 145663 };			// Pi�ge explosif a distance 82939, Pi�ge de glace a distance 82941, Marque du chasseur 145663
			...
			uint32 branche1_3[3] = { 145654, 145654, 48098 };							// Tir du cobra 145654 , Fl�ches multiples 48098 3s
			uint32 branche1_4[2] = { 80003, 5116 };										// Fl�che noire 80003 18s, Trait de choc 5116 6s
			...
			uint32 branche2_agro[6] = { 13813, 13809, 19386, 19577, 19386, 19577 };				// Pi�ge explosif 13813, Pi�ge de glace 13809, Piq�re de wyverne 19386, Intimidation 19577
			...
			void UpdateAI(uint32 diff) override
			{
				...
				case 1: // Sp�cialisation Survie ------------------------------------------------------------------------------------------------------------------
					...
					if (!me->isInFront(victim, Dist))																		// Si la cible n'est pas de face
						...
						// Spell4 sur la cible  (Sort secondaire tres lent , g�n�ralement utilis?comme Dot) : Fl�che noire 3674 18s, Morsure de serpent 31975 15s
					...
					// Spell3 sur la cible  (Sort secondaire tres lent , g�n�ralement utilis?comme Dot) : Tir du cobra 77767, Fl�ches multiples 2643 3s
					...
					// Spell1 sur la cible chaque (Sort R�guli? : Tir des arcanes
				...
				case 2: // Sp�cialisation Bete --------------------------------------------------------------------------------------------------------------------
					...
					// Spell2 sur la cible chaque (Sort secondaire plus lent) : Tir assur?
					...
					// Spell3 sur la cible  (Sort secondaire tres lent , g�n�ralement utilis?comme Dot) : Courroux bestial 19574 60s, Ordre de tuer 34026 30s
